...
def load_model(checkpoint,device):
    ...
    model=SurfaceModeGeometry(mode_pool=payload['config']['variant']=='mode_pool',radius_px=payload['config']['surface_radius_px']).to(device).eval();model.load_state_dict(payload['model'])
